"""
joins in pandas
combaine multiple dataframes based on column
"""
movies_data = [
...
#pd.merge(df1,df2,on="column",how="inner,left,right joins")
data=pd.merge(movies,review,left_on="id",right_on="movie_id",how="inner")
print(data.head(3))

#movie wise review
print(data["title"].value_counts())

#average rating and their movie
print(data.groupby("title")["rating"].mean())

#years_wise movie count
